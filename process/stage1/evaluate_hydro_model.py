...
RESULTS_CSV_PATH = RESULTS_DIR / (
    "hydro_forecast.csv" if EVAL_ON_FULL_DATASET else "validation_hydro_forecast.csv"
)
RESULTS_PLOT_PATH = RESULTS_DIR / (
    "hydro_timeseries.png" if EVAL_ON_FULL_DATASET else "validation_hydro_timeseries.png"
)
...
print(f"Wrote {'hydro-dataset' if EVAL_ON_FULL_DATASET else 'validation'} CSV to: {RESULTS_CSV_PATH}")
print(f"Wrote {'hydro-dataset' if EVAL_ON_FULL_DATASET else 'validation'} plot to: {RESULTS_PLOT_PATH}")
