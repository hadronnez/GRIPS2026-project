...
SOLAR_PATH = ROOT / "output/data_preprocessing/clean_datasets/Photovoltaic.csv"

PARAMS_DIR = ROOT / "process/stage1/parameters"
MODEL_PATH = PARAMS_DIR / "solar_model.pt"
...
RESULTS_CSV_PATH = RESULTS_DIR / (
    "solar_forecast.csv" if EVAL_ON_FULL_DATASET else "validation_solar_forecast.csv"
)
RESULTS_PLOT_PATH = RESULTS_DIR / (
    "solar_timeseries.png" if EVAL_ON_FULL_DATASET else "validation_solar_timeseries.png"
)
...
print(f"Wrote {'solar-dataset' if EVAL_ON_FULL_DATASET else 'validation'} CSV to: {RESULTS_CSV_PATH}")
print(f"Wrote {'solar-dataset' if EVAL_ON_FULL_DATASET else 'validation'} plot to: {RESULTS_PLOT_PATH}")
