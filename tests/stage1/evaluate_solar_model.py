...
from tests.stage1.model.model import ResidualNet
...
RESULTS_CSV_PATH = RESULTS_DIR / "solar_improved_forecast.csv"
RESULTS_PLOT_PATH = RESULTS_DIR / "solar_improved_timeseries.png"
